...
#### LO 51.8: Describe the steps in valuing an MBS using Monte Carlo Simulation.

- Monte Carlo is actually a process of steps rather than a specific model.
- When yield volatility is assumed for each maturity, it is referred to as term structure yield volatility.

#### LO 51.9: Define Option Adjusted Spread (OAS), and explain its challenges and its uses.
