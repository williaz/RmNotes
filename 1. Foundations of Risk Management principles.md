...
- Kidder Peabody: report false profits -> investigating large profits from unknown trading strategies.
- Barings: little management oversight o f the settlement process
- Allied Irish Bank
- Union Bank o f Switzerland (UBS): failed to properly analyze and stress test its positions.
- Societe Generate
